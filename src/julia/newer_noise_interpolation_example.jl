...
include("newer_noise_interpolation.jl")
rng_original = MersenneTwister(123)
...
rng = jump_realizations(rng, (m-1)*N*P*nx)
function w_new(t::Float64)
    return (C*noise_inter_new(t, Ts, A, B, x_mat[:, m], rng,
