...
pend_model_data = let
    ...
    model_sens = pendulum_forward_k_1a                                 # For forward sensitivity
    model_adjoint = pendulum_adjoint_k_1a                              # For adjoint sensitivity
    model_adjoint_odedist = pendulum_adjoint_k_1a_ODEdist           # Adjoint when disturbances are given by an ODE incorporated into the DAE
