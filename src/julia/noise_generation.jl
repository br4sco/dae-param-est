...
# # NOTE: I don't think this function works with the current implementation
# # Stores disturbance data and metadata generated by the function gen()
# function store_disturbance_data(gen::Function, Ts::Float64, data_path, metadata_path)
#     data, metadata = gen(Ts)
#     if !isfile(data_path)
#         # data expected to be of type Array{Float64, 2}
#         writedlm(data_path, data, ',')
#     else
